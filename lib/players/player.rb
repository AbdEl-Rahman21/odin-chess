...
class Player
  ...
  def create_pieces
    ...
    @pieces = [Pawn.new([1, j], @color), Pawn.new([2, j], @color), Pawn.new([3, j], @color), Pawn.new([4, j], @color),
               ...
               Rook.new([1, i], @color), Rook.new([8, i], @color), Knight.new([2, i], @color), Knight.new([7, i], @color),
               Bishop.new([3, i], @color), Bishop.new([6, i], @color), Queen.new([4, i], @color), King.new([5, i], @color)]
  end
